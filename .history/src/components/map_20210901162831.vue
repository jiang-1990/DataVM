  ...
  methods: {
    ...
    const myChart = echarts.init(document.getElementById("mapChart"));
      ...
      var XAData = [
        ...
        [{ name: "哈尔滨" }, { name: "银川", value: 100 }],
        [{ name: "拉萨" }, { name: "北京", value: 100 }],
        [{ name: "拉萨" }, { name: "上海", value: 100 }],
        [{ name: "拉萨" }, { name: "广州", value: 100 }],
        [{ name: "拉萨" }, { name: "西宁", value: 100 }],
        [{ name: "拉萨" }, { name: "银川", value: 100 }],
      ];

      var XNData = [
        [{ name: "内蒙" }, { name: "北京", value: 100 }],
        [{ name: "内蒙" }, { name: "上海", value: 100 }],
        [{ name: "内蒙" }, { name: "广州", value: 100 }],
        [{ name: "内蒙" }, { name: "西安", value: 100 }],
        [{ name: "内蒙" }, { name: "银川", value: 100 }],
      ];
      ...
      var color = ["#ç", "#ffa022", "#46bee9"]; //航线的颜色
      var series = [];
      [
        ["西安", XAData],
        ["西宁", XNData],
